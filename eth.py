...
def fetch_data():
    ...
    #ETC INFO:
    close = kraken.fetch_ticker("ETH/USD")["last"]
    datetime = kraken.fetch_ticker("ETH/USD")["datetime"]
    open1 = kraken.fetch_ticker("ETH/USD")["open"]
    last = kraken.fetch_ticker("ETH/USD")["last"]
